...
def count_words_sequential(file_path):
    ...
    with open(file_path, 'r', encoding='utf-8') as f:
        for line in f:
            # Utilizăm regex pentru a extrage doar cuvintele (alfanumerice)
            # Aceeași logică ca în versiunea MultiProcessing
...
if __name__ == "__main__":
    ...
    file_name = os.path.join(base_dir, "../../data/large_text.txt") 
